...
A simple LSTM text generation example using a pre-trained model on a corpus of [Ernest Hemingway](https://en.wikipedia.org/wiki/Ernest_Hemingway) using ML5.js and [p5.js](https://p5js.org/). You can train your own images following [this tutorial](#). You can also find the same example without p5.js [here](https://github.com/ml5js/ml5-examples)
